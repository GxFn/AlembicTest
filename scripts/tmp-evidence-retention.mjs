...
function printHelp() {
  process.stdout.write(`Audit AlembicTest/tmp raw evidence retention.
...
Usage:
  node AlembicTest/scripts/tmp-evidence-retention.mjs [options]

Options:
  --tmp-dir <path>       Evidence directory. Default: AlembicTest/tmp
...
Examples:
  node AlembicTest/scripts/tmp-evidence-retention.mjs
...
function printText(report) {
  process.stdout.write(`AlembicTest tmp evidence retention audit (${report.mode})\n`);
